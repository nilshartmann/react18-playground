module.exports = [
  { id: "1", postId: "P10", comment: "Good article" },
  {
    id: "2",
    postId: "P10",
    comment: "laudantium enim quasi est quidem magnam voluptate ipsam eos",
  },
  { id: "3", postId: "P9", comment: "tempora quo necessitatibus" },
  {
    id: "4",
    postId: "P8",
    comment:
  ...
  { id: "5", postId: "P7", comment: "Indolor quam autem quasi" },
  { id: "6", postId: "P7", comment: "reiciendis et nam sapiente accusantium" },
  {
    id: "7",
    postId: "P7",
    comment:
  ...
  },
  {
    ...
    postId: "P2",
    comment:
      "I'll be sure to note that in my log. Smooth as an android''s bottom, eh, Data? ",
  },
  {
    id: "9",
    postId: "P1",
